...
type EventMessage struct {
	...
	AppOpened            bool                       `protobuf:"varint,5,opt,name=appOpened,proto3" json:"appOpened,omitempty"`
	AppBackgrounded      bool                       `protobuf:"varint,6,opt,name=appBackgrounded,proto3" json:"appBackgrounded,omitempty"`
	SessionStarted       bool                       `protobuf:"varint,7,opt,name=sessionStarted,proto3" json:"sessionStarted,omitempty"`
	SessionEnded         bool                       `protobuf:"varint,8,opt,name=sessionEnded,proto3" json:"sessionEnded,omitempty"`
	...
	DynamicConfigChanged bool                       `protobuf:"varint,15,opt,name=dynamicConfigChanged,proto3" json:"dynamicConfigChanged,omitempty"`
	CustomAttributes     map[string]*structpb.Value `protobuf:"bytes,16,rep,name=customAttributes,proto3" json:"customAttributes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *EventMessage) GetCustomAttributes() map[string]*structpb.Value {
	if x != nil {
...
const file_internal_grpc_proto_event_proto_rawDesc = "" +
	"\n" +
	"\x1finternal/grpc/proto/event.proto\x12\x03log\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!internal/grpc/proto/context.proto\x1a\x1cgoogle/protobuf/struct.proto\"6\n" +
	"\tEventList\x12)\n" +
	"\x06events\x18\x01 \x03(\v2\x11.log.EventMessageR\x06events\"\xb4\x05\n" +
	"\fEventMessage\x12\x18\n" +
	"\aeventID\x18\x01 \x01(\tR\aeventID\x12\x1c\n" +
	"\teventName\x18\x02 \x01(\tR\teventName\x12\x1e\n" +
	"\n" +
	"screenName\x18\x03 \x01(\tR\n" +
	"screenName\x128\n" +
	"\teventTime\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\teventTime\x12\x1c\n" +
	"\tappOpened\x18\x05 \x01(\bR\tappOpened\x12(\n" +
	"\x0fappBackgrounded\x18\x06 \x01(\bR\x0fappBackgrounded\x12&\n" +
	"\x0esessionStarted\x18\a \x01(\bR\x0esessionStarted\x12\"\n" +
	"\fsessionEnded\x18\b \x01(\bR\fsessionEnded\x12\x1a\n" +
	"\blatitude\x18\t \x01(\x01R\blatitude\x12\x1c\n" +
	"\tlongitude\x18\n" +
	" \x01(\x01R\tlongitude\x12\x12\n" +
	"\x04city\x18\v \x01(\tR\x04city\x12\x16\n" +
	"\x06region\x18\f \x01(\tR\x06region\x12\x18\n" +
	"\acountry\x18\r \x01(\tR\acountry\x12\x18\n" +
	"\acarrier\x18\x0e \x01(\tR\acarrier\x122\n" +
	"\x14dynamicConfigChanged\x18\x0f \x01(\bR\x14dynamicConfigChanged\x12S\n" +
	"\x10customAttributes\x18\x10 \x03(\v2'.log.EventMessage.CustomAttributesEntryR\x10customAttributes\x1a[\n" +
...
var file_internal_grpc_proto_event_proto_depIdxs = []int32{
	...
	5, // 3: log.EventMessage.CustomAttributesEntry.value:type_name -> google.protobuf.Value
	1, // 4: log.EventService.SendEvent:input_type -> log.EventMessage
	0, // 5: log.EventService.SendEventList:input_type -> log.EventList
	2, // 6: log.EventService.SendEventFile:input_type -> log.EventFileRequest
	6, // 7: log.EventService.SendEvent:output_type -> log.Response
	6, // 8: log.EventService.SendEventList:output_type -> log.Response
	6, // 9: log.EventService.SendEventFile:output_type -> log.Response
