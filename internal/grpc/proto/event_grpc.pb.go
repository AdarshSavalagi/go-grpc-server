...
func (c *eventServiceClient) SendEvent(ctx context.Context, in *EventMessage, opts ...grpc.CallOption) (*Response, error) {
...
func (c *eventServiceClient) SendEventList(ctx context.Context, in *EventList, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
...
func (UnimplementedEventServiceServer) SendEvent(context.Context, *EventMessage) (*Response, error) {
